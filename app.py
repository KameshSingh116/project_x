...
with col2:
    st.image("https://cdn.prod.website-files.com/635637c5d13ee9bd2b5feb65/64baa41efc3042f9a129fda0_Thumbnail-Medchat.png")
...
# Load the prebuilt FAISS vector database
